...
Version 0.2.5 supports GLPI 11.0.8 through 11.0.x and PHP 8.2 or newer. Confirm
that Sodium is enabled and back up both the database and `glpicrypt.key` before
installation or upgrade.

Uninstalling 0.2.5 disables the plugin but intentionally retains its database
